<%-- 
    Document   : Verify
    Created on : Jul 16, 2014, 4:00:49 PM
    Author     : mvinoth
--%>
...
<html>
  ...
  int randomInteger=0;
      ...
      randomInteger = random.nextInt(9999);
      System.out.println("Random Integer in Java: " + randomInteger);
 


String pass=String.valueOf(randomInteger);
                      String Query="Update booking_service set Status1='"+ss+"',U_Pass='"+pass+"' where S_No='"+ids+"'";
