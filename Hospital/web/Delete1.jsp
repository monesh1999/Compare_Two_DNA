		    	...
		    	<div class="content">
                            ...
                            <br>
                                ...
                                <%
                                        ...
                                        int i=db.Insert("delete from provider_hospital where S_No='"+id1+"'");
                                     if(i>0)
{
  session.setAttribute("msg","Service Successfully Deleted");
                    response.sendRedirect("Modify_Partner.jsp");   
}
else
{
     session.setAttribute("msg","Service Can't Deleted");
                    response.sendRedirect("Modify_Partner.jsp"); 
}
