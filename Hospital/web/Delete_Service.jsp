				...
				<div class="logo">
					<a href="#"><img src="images/logo.png" title="logo" /></a>
                     ...
                     session.setAttribute("User",name);
                                    ...
                                    ResultSet rs=db.Select("select * from user_registration where S_No='"+id+"' and U_Name='"+name+"'");
                                    if(rs.next())
                                    {
                                        String care=rs.getString("U_Name");
		    ...
		    <div class="wrap">
		    	<div class="content">
                            <center>
                                <br>
                                <br>
                                SERVICE DETAILS<br><br><table>
                         <%
                                        String id1=request.getParameter("id1");
                                        int id2=Integer.parseInt(id1);
                                        int i=db.Insert("delete from booking_service where S_No='"+id2+"'");
                                     if(i>0)
{
  session.setAttribute("msg","Service Successfully Deleted");
                    response.sendRedirect("Services_Details.jsp");   
}
else
{
