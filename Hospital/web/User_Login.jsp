		    ...
		    <div class="wrap">
		    	<div class="content">
                              <form action="User_Check" method="post" onsubmit="JavaScript:return AdminValidate(true);">
                                  <center> <br>  <br><br> <h2>USER LOGIN PAGE</h2> <br><br>
                                  <br><table border="5">
                                          
                    <tr><td> <font color="red"> AADHAR ID :</td><td><input type="text" value="" id="U_Name" name="U_Name" required pattern="[0-9]{16}"></td></tr>
                    <tr></tr><tr></tr>
